    ...
    <div class="admin-wrapper">
        ...
        <div class="admin-content">
            ...
            <div class="content">
                ...
                <h2 class="page-title">Update Testimonials</h2>
                ...
                <form  action="edit.php" method=post enctype="multipart/form-data" >
                    ...
                    <div>
                     ...
                     <div>
                        <label>Body</label>
                        <textarea  name="testimonial"  id="body"><?php echo $testimonial; ?></textarea>
                    ...
                    <div>
                        <button name="update-testimonial" class="btn btn-big">Update Testimonial</button>
